export const trustItems = [
  {
    ...
    description: 'Clear paths to call, book, visit, or buy.',
  },
  {
    icon: 'layers',
    title: 'Practical by Design',
    description: 'A focused first version that solves the real need.',
  },
  {
    icon: 'my_location',
    title: 'Easy to Find',
    description: 'Give customers the information they need, fast.',
  },
  {
    icon: 'bolt',
    title: 'Ready to Use',
    description: 'Built, launched, and ready for the next customer.',
  },
  {
    icon: 'groups',
    title: 'Support That Has Boundaries',
    description: 'Clear care plans and a real person to contact.',
  },
]
